...
public class TerraPizzaPage {
  ...
  // public static final String PIZZA = "//li[@class='menu-navigation__item']/a[@href='/catalog/picca']";
    public static final String ADD_TO_CART = "//button[@data-hrf='/cart/add-basket?id=364']";
